...
const APPROVED_CATEGORY_LABELS: Record<string, string> = {
  ...
  ALTERATION_OR_OBSTRUCTION: 'Alteration or visual obstruction',
  ...
  const queueItems: QueueItem[] = useMemo(() => {
    ...
    return storeCases
      .map((c) => ({
        ...
        computedClassification: c.spatialResult?.classification || c.computedClassification,
