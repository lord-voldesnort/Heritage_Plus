          ...
          <div className="space-y-2">
            ...
            {!isGpsAcquired && (
              <button
                ...
                className="w-full flex items-center justify-center gap-2 p-3 rounded-xl border border-slate-700 bg-slate-900 hover:bg-slate-850 text-slate-200 font-medium text-xs transition-colors shadow-sm"
              >
                {gpsLoading ? (
                  <>
