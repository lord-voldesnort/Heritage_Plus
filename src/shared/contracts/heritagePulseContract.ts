...
export function buildCanonicalReviewerPacketData(
  ...
  return {
    ...
    spatialVerdict: {
      classification: observation.spatialResult?.classification || observation.computedClassification || 'LOCATION_UNCERTAIN',
      distanceToBoundaryMeters: observation.spatialResult?.distanceToBoundaryMeters ?? observation.distanceToBoundaryMeters ?? null,
