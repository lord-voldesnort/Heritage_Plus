  ...
  it('Requirement A3.5: builds canonical reviewer packet with complete provenance block', () => {
    const mockObservation: ObservationRecord = {
      ...
      spatialResult: {
        ...
        explanation: 'Point within protected area.',
        statements: {
          userReported: 'Observed foundation works near perimeter.',
          gisCalculated: 'Point within protected area.',
          authorityNotice: 'Official review required.',
        },
      },
