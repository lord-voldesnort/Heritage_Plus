...
export class LedgerStore {
  ...
  constructor(adapter?: PersistenceAdapter) {
    ...
    this.demoCaseIds = new Set<string>();
  }
  ...
  public saveToStorage(): void {
    this.adapter.saveCases(this.cases);
  }
      ...
      ? [
          {
            ...
            fileSizeBytes: data.evidenceMetadata?.fileSizeBytes || (data.photoMetadata?.sizeKb ? data.photoMetadata.sizeKb * 1024 : 1024000),
