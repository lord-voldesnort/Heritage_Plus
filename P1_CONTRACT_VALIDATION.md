...
**Heritage Pulse (αñ╣αÑçαñ░αñ┐αñƒαÑçαñ£ αñ¬αñ▓αÑìαñ╕) ΓÇö SIH 2026 PS 26197**  
...
Γö£ΓöÇΓöÇ docs/                     # Specifications, contracts, demo blueprints, and QA
Γöé   Γö£ΓöÇΓöÇ API_CONTRACT.md
Γöé   Γö£ΓöÇΓöÇ ARCHITECTURE.md
Γöé   Γö£ΓöÇΓöÇ DATA_MODEL.md
Γöé   Γö£ΓöÇΓöÇ DEFINITIONS_OF_DONE.md
Γöé   Γö£ΓöÇΓöÇ DEMO_PLAN.md
Γöé   Γö£ΓöÇΓöÇ GEOMETRY_GATE.md
Γöé   Γö£ΓöÇΓöÇ JUDGE_QA.md
Γöé   Γö£ΓöÇΓöÇ ONBOARDING.md
Γöé   Γö£ΓöÇΓöÇ PRODUCT_CONTRACT.md
Γöé   Γö£ΓöÇΓöÇ PS_FIT.md
Γöé   Γö£ΓöÇΓöÇ TASK_BOARD.md
Γöé   Γö£ΓöÇΓöÇ TEAM_GUIDE.md
Γöé   ΓööΓöÇΓöÇ USER_FLOWS.md
Γö£ΓöÇΓöÇ project/                  # Gate and team governance tracking
Γöé   Γö£ΓöÇΓöÇ GATE_STATUS.json
Γöé   Γö£ΓöÇΓöÇ PRODUCT_RULES.json
Γöé   Γö£ΓöÇΓöÇ TASK_STATUS.json
Γöé   ΓööΓöÇΓöÇ TEAM_MEMBERS.json
Γö£ΓöÇΓöÇ scripts/                  # Automated verification and task CLI scripts
Γöé   Γö£ΓöÇΓöÇ check-gate.mjs
Γöé   Γö£ΓöÇΓöÇ show-next-task.mjs
Γöé   Γö£ΓöÇΓöÇ validate-contract.mjs
Γöé   ΓööΓöÇΓöÇ validate-task-status.mjs
Γö£ΓöÇΓöÇ src/
Γöé   Γö£ΓöÇΓöÇ App.tsx               # Main routes & ReviewerRoleGate
Γöé   Γö£ΓöÇΓöÇ main.tsx              # React DOM entry point
Γöé   Γö£ΓöÇΓöÇ index.css             # Tailwind and global typography styles
Γöé   Γö£ΓöÇΓöÇ types/
Γöé   Γöé   ΓööΓöÇΓöÇ case.ts           # GovernanceCaseStatus & rationale validator
Γöé   Γö£ΓöÇΓöÇ shared/
Γöé   Γöé   Γö£ΓöÇΓöÇ components/       # Reusable UI widgets & DemoQuickbar
Γöé   Γöé   Γö£ΓöÇΓöÇ constants/        # Categories, statuses, classifications, disclaimers
Γöé   Γöé   Γö£ΓöÇΓöÇ lib/              # spatialEngine, ledgerStore, caseGenerator
Γöé   Γöé   Γö£ΓöÇΓöÇ mock-data/        # siteGeometry, mockSite, mockScenarios, mockCases
Γöé   Γöé   ΓööΓöÇΓöÇ types/            # Canonical shared TypeScript interfaces (index.ts)
Γöé   Γö£ΓöÇΓöÇ features/
Γöé   Γöé   Γö£ΓöÇΓöÇ site-context/     # SiteContextPage, observationGuidelines
Γöé   Γöé   Γö£ΓöÇΓöÇ field-capture/    # FieldCapturePage, GpsAccuracyHud
Γöé   Γöé   Γö£ΓöÇΓöÇ spatial-result/   # SpatialResultPage, SpatialMapCard, CaseDetailPage
Γöé   Γöé   Γö£ΓöÇΓöÇ change-ledger/    # ChangeLedgerPage, CaseDetailPage (re-export)
Γöé   Γöé   Γö£ΓöÇΓöÇ reviewer-workflow/# ReviewerQueuePage, ReviewerConsolePage, ReviewerActionCard
Γöé   Γöé   Γö£ΓöÇΓöÇ reviewer-packet/  # ReviewerPacketPreview, ReviewerPacketPage
Γöé   Γöé   Γö£ΓöÇΓöÇ ps-fit/           # PsFitPage
Γöé   Γöé   Γö£ΓöÇΓöÇ judge-qa/         # JudgeQaPage
Γöé   Γöé   ΓööΓöÇΓöÇ team-status/      # TeamStatusPage
Γöé   ΓööΓöÇΓöÇ test/                 # Vitest test suites
Γöé       Γö£ΓöÇΓöÇ e2e-journey.test.ts
Γöé       ΓööΓöÇΓöÇ regression-and-journey.test.ts
Γö£ΓöÇΓöÇ BACKEND_SCHEMA.sql        # PostGIS DDL, spatial trigger, and seed data
ΓööΓöÇΓöÇ package.json              # Vite, Vitest, React, MapLibre, Turf.js
```
...
```text
               ...
               Γöé  SUBMITTED_FOR_REVIEW  Γöé
               ΓööΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓö¼ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÿ
         ΓöîΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓö╝ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÉ
         Γû╝                 Γû╝                  Γû╝
ΓöîΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÉ ΓöîΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÉ ΓöîΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÉ
Γöé ADDITIONAL_INFO_ Γöé Γöé REFERRED  Γöé Γöé FIELD_VERIFICATION Γöé
Γöé     NEEDED       Γöé ΓööΓöÇΓöÇΓöÇΓöÇΓöÇΓö¼ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÿ Γöé    RECOMMENDED     Γöé
ΓööΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓö¼ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÿ       Γöé       ΓööΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓö¼ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÿ
         Γöé                 Γû╝                  Γöé
         Γöé          ΓöîΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÉ           Γöé
         ΓööΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓû║Γöé   CLOSED_   ΓöéΓùäΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÿ
                    Γöé  REVIEWED   Γöé
...
| 3 | `scenario-3-near-boundary` | $19.1931225^\circ\text{N}, 73.8528893^\circ\text{E}$ | $\pm 30.0\text{m}$ | `LOCATION_UNCERTAIN` | `LOCATION_UNCERTAIN` ($d \le r_{gps}$) | Accuracy circle overlap ΓÇö refuses to overclaim | `VERIFIED` |
...
1. **Ad-hoc Case ID & Session Payload in `FieldCapturePage.tsx`**:
   - Lines 91ΓÇô110 generate `case-${Date.now()}` and construct `SessionCasePayload` instead of calling `ledgerStore.createCase`.
...
1. [`src/features/field-capture/FieldCapturePage.tsx`](file:///E:/Heritage_Guard/Heritage_Plus/src/features/field-capture/FieldCapturePage.tsx) ΓÇö Connect form submission to `ledgerStore.createCase` & `calculateSpatialResult`.
2. [`src/features/reviewer-workflow/ReviewerQueuePage.tsx`](file:///E:/Heritage_Guard/Heritage_Plus/src/features/reviewer-workflow/ReviewerQueuePage.tsx) ΓÇö Streamline case triage queue data binding.
3. [`src/features/reviewer-workflow/ReviewerConsolePage.tsx`](file:///E:/Heritage_Guard/Heritage_Plus/src/features/reviewer-workflow/ReviewerConsolePage.tsx) ΓÇö Complete split-pane triage and action card workflow (`[REVIEW-01]`).
4. [`src/features/reviewer-packet/ReviewerPacketPreview.tsx`](file:///E:/Heritage_Guard/Heritage_Plus/src/features/reviewer-packet/ReviewerPacketPreview.tsx) ΓÇö Polish print layout and export actions (`[PACKET-01]`).
5. [`src/shared/components/DemoQuickbar.tsx`](file:///E:/Heritage_Guard/Heritage_Plus/src/shared/components/DemoQuickbar.tsx) ΓÇö Verify scenario switching reliability.
